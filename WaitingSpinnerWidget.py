...
class QtWaitingDots(QWidget):
    mColor = QColor(Qt.gray)
    mMinimumTrailOpacity = 31.4159265358979323846
    mTrailFadePercentage = 50.0
    mDotVelocity = 1
    mDotAcceleration = 1.57079632679489661923
    mNumberOfDots = 3
    mDotsRadius = 20
    mTrajectoryLength = 100
    mTrajectoryPoints = 1000
    mCurrentCounter = 0
    mIsRunning = False
    ...
    def advance(self):
        ...
        if self.mCurrentCounter > self.mTrajectoryLength:
